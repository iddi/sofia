...
class RDFTransactionList:
	...
	def add_uri( self, s, p, o, bnode = False ):
		...
		o1=str(o)
		if bnode:
			self.rdftranslist.append(Triple(bNode(s1),URI(p1),URI(o1)))
			#self.rdftranslist.append(((s1, p1, o1), "bnode", "uri"))
		else:
			self.rdftranslist.append(Triple(URI(s1),URI(p1),URI(o1)))
	...
	def add_literal( self, s, p, o, bnode = False):
		...
		o1=str(o)	
		if bnode:
			self.rdftranslist.append(Triple(bNode(s1),URI(p1),Literal(o1)))
			#self.rdftranslist.append(((s1,p1,o1), "bnode", "literal"))
		else:
			self.rdftranslist.append(Triple(URI(s1),URI(p1),Literal(o1)))
