 ...
 *
 */
public class SemanticContentListenerRequest extends ViewerRequest {
	
	private ISemanticContentHolderListener listener;
	
	public SemanticContentListenerRequest(ISemanticContentHolderListener listener, SIB sib) {
		super(sib);
	...
	public void processRequest() {
		if (addListener) {
			...
			listener.initTriples(sib.getSemanticModel().getAllTriples(), "SIB");
		} else {
